package com.vpn.vpnandroid.build
...
object Dependencies {
    ...
    object AndroidX {
        ...
        @JvmStatic val databinding = dependency("androidx.databinding:databinding-runtime:${Versions.databinding}")
    ...
    object Parser {
        ...
        @JvmStatic val gson = dependency("com.google.code.gson:gson:${Versions.gson}")
    }
    ...
    object Coroutines {
        @JvmStatic val coroutinesCore = dependency("org.jetbrains.kotlinx:kotlinx-coroutines-core:${Versions.coroutines}")
        @JvmStatic val coroutinesAndroid = dependency("org.jetbrains.kotlinx:kotlinx-coroutines-android:${Versions.coroutines}")
    }
