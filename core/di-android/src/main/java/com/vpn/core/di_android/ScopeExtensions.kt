package com.vpn.core.di_android
...
fun <F> F.fragmentScope() where F : Fragment, F : DependenciesComponent =
    lifecycleOwnerScope(getKoin())

fun <A> A.activityScope() where A : AppCompatActivity, A : DependenciesComponent =
    lifecycleOwnerScope(getKoin())
